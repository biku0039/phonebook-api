...
$webMvcFolder = Join-Path $slnFolder "src/ANZ104AngularDemo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/ANZ104AngularDemo.Web.Public"
...
dotnet restore ANZ104AngularDemo.Web.sln
