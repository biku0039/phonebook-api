...
namespace ANZ104AngularDemo.Web.Security.Recaptcha
{
    public class RecaptchaValidator : ANZ104AngularDemoServiceBase, IRecaptchaValidator, ITransientDependency
    {
