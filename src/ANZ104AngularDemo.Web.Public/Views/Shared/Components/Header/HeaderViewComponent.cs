...
using ANZ104AngularDemo.Web.Public.Startup;
using ANZ104AngularDemo.Web.Session;

namespace ANZ104AngularDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ANZ104AngularDemoViewComponent
    {
