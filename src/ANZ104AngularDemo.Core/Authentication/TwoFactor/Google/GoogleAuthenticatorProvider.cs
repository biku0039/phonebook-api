...
namespace ANZ104AngularDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ANZ104AngularDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ANZ104AngularDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
