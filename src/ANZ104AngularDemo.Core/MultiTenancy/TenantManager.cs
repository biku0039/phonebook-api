...
using ANZ104AngularDemo.MultiTenancy.Demo;
...
namespace ANZ104AngularDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ANZ104AngularDemoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ANZ104AngularDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
