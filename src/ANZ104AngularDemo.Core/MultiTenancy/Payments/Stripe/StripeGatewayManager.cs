...
{
    public class StripeGatewayManager : ANZ104AngularDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ANZ104AngularDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ANZ104AngularDemoConsts.Currency;
        }
