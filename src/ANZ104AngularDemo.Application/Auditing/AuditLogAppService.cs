...
using ANZ104AngularDemo.Auditing.Exporting;
...
using EntityHistoryHelper = ANZ104AngularDemo.EntityHistory.EntityHistoryHelper;

namespace ANZ104AngularDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ANZ104AngularDemoAppServiceBase, IAuditLogAppService
    {
