...
using ANZ104AngularDemo.Authorization.Users.Profile.Cache;
...
using ANZ104AngularDemo.Gdpr;
using ANZ104AngularDemo.Net.Sms;
using ANZ104AngularDemo.Security;
using ANZ104AngularDemo.Storage;
using ANZ104AngularDemo.Timing;

namespace ANZ104AngularDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ANZ104AngularDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("ANZ104AngularDemo",
