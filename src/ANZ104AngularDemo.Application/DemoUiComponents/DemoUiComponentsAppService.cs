...
using ANZ104AngularDemo.DemoUiComponents.Dto;

namespace ANZ104AngularDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ANZ104AngularDemoAppServiceBase, IDemoUiComponentsAppService
    {
