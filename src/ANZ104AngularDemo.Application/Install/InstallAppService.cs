...
using ANZ104AngularDemo.Migrations.Seed.Host;
...
namespace ANZ104AngularDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ANZ104AngularDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ANZ104AngularDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ANZ104AngularDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ANZ104AngularDemoConsts.ConnectionStringName}", constring);
        }
