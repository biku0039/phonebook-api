...
using ANZ104AngularDemo.UiCustomization;
...
{
    public class SessionAppService : ANZ104AngularDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ANZ104AngularDemoConsts.Currency,
                        CurrencySign = ANZ104AngularDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ANZ104AngularDemoConsts.AllowTenantsToChangeEmailSettings,
