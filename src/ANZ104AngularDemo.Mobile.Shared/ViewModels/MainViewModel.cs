...
using ANZ104AngularDemo.Commands;
using ANZ104AngularDemo.Core.Threading;
using ANZ104AngularDemo.Models.NavigationMenu;
using ANZ104AngularDemo.Services.Navigation;
...
using ANZ104AngularDemo.ApiClient;
using ANZ104AngularDemo.Controls;
using ANZ104AngularDemo.Dto;
using ANZ104AngularDemo.Extensions;
using ANZ104AngularDemo.Localization;
using ANZ104AngularDemo.UI;
using ANZ104AngularDemo.UI.Assets;
using ANZ104AngularDemo.Views;
using DependencyResolver = ANZ104AngularDemo.Core.Dependency.DependencyResolver;
...
namespace ANZ104AngularDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "ANZ104AngularDemo";
