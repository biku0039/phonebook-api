...
namespace ANZ104AngularDemo.Core.Base
{
    public abstract class ANZ104AngularDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ANZ104AngularDemoQueryBase(string fieldName,
