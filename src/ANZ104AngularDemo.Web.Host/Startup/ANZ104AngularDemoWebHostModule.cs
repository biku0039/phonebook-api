...
using ANZ104AngularDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace ANZ104AngularDemo.Web.Startup
{
    ...
    public class ANZ104AngularDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ANZ104AngularDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ANZ104AngularDemoWebHostModule).GetAssembly());
        }
