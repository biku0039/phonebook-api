...
{
    public class SubscriptionPaymentRepository : ANZ104AngularDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ANZ104AngularDemoDbContext> dbContextProvider)
