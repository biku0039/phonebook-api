...
using ANZ104AngularDemo.MultiTenancy.HostDashboard;
...
namespace ANZ104AngularDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ANZ104AngularDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
